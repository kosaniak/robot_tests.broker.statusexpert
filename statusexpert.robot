...
Пошук тендера по ідентифікатору
  ...
  Run Keyword And Return If   "UA-AR-P" in "${auction_id}"     statusexpert.Пошук об’єкта МП по ідентифікатору   ${user_name}   ${auction_id}
  Run Keyword And Return If   "UA-LR-SSP" in "${auction_id}"   statusexpert.Пошук лоту по ідентифікатору         ${user_name}   ${auction_id}
...
Пошук тендера у разі наявності змін
  ...
  Run Keyword If   ${status}   statusexpert.Пошук тендера по ідентифікатору   ${user_name}   ${auction_id}
...
Завантажити документ в тендер з типом
  ...
  statusexpert.Пошук тендера по ідентифікатору   ${user_name}   ${auction_id}
...
Завантажити документ
  ...
  statusexpert.Завантажити документ в тендер з типом   ${user_name}   ${auction_id}   ${file_path}
...
Отримати інформацію із тендера
  [Arguments]   ${user_name}   ${auction_id}   ${field}
  statusexpert.Пошук тендера у разі наявності змін   ${TENDER['LAST_MODIFICATION_DATE']}   ${user_name}   ${auction_id}
...
Завантажити ілюстрацію
  [Arguments]   ${user_name}   ${auction_id}   ${file_path}
  statusexpert.Завантажити документ в тендер з типом   ${user_name}   ${auction_id}   ${file_path}   illustration
...
Оновити сторінку з об'єктом МП
  [Arguments]   ${user_name}   ${asset_id}
  statusexpert.Пошук об’єкта МП по ідентифікатору   ${user_name}   ${asset_id}
...
Завантажити ілюстрацію в об'єкт МП
  ...
  statusexpert.Завантажити документ в об'єкт МП з типом   ${user_name}   ${asset_id}   ${file_path}   illustration
...
Оновити сторінку з лотом
  ...
  statusexpert.Пошук лоту по ідентифікатору   ${user_name}   ${lot_id}
...
Завантажити ілюстрацію в лот
  [Arguments]   ${user_name}   ${lot_id}   ${file_path}
  statusexpert.Завантажити документ в лот з типом   ${user_name}   ${lot_id}   ${file_path}   illustration
