...
Пошук тендера у разі наявності змін
  ...
  statusexpertПошук тендера по ідентифікатору   ${user_name}   ${auction_id}
...
Отримати кількість предметів в тендері
  ...
  statusexpertПошук тендера по ідентифікатору   ${username}   ${tender_uaid}
...
Завантажити документ
  ...
  statusexpertЗавантажити документ в тендер з типом   ${user_name}   ${auction_id}   ${file_path}
...
Отримати інформацію із тендера
  [Arguments]   ${user_name}   ${auction_id}   ${field}
  statusexpertПошук тендера у разі наявності змін   ${TENDER['LAST_MODIFICATION_DATE']}   ${user_name}   ${auction_id}
...
Завантажити ілюстрацію
  [Arguments]   ${user_name}   ${auction_id}   ${file_path}
  statusexpertЗавантажити документ в тендер з типом   ${user_name}   ${auction_id}   ${file_path}   illustration
